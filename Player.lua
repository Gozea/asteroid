...
function Player:draw()
    ...
    love.graphics.polygon("line", x + self.size*self.direction.x, y + self.size*self.direction.y, x + (self.size/2)*cpml.vec2.rotate(self.direction, 2.1).x, y + (self.size/2)*cpml.vec2.rotate(self.direction, 2.1).y, x + (self.size/2)*cpml.vec2.rotate(self.direction, 4.2).x, y + (self.size/2)*cpml.vec2.rotate(self.direction, 4.2).y)
end
